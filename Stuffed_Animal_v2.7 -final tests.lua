...
gpio.trig(touch_pin1, "up" ,function() if(head_sensor_status == 1) then vibrate() end end)
gpio.trig(touch_pin2, "up" ,function() if(back_sensor_status == 1) then vibrate() end end)
gpio.trig(touch_pin3, "up" ,function() if(tummy_sensor_status == 1) then vibrate() end end)
